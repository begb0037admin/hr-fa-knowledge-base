...
- **Status (27 August 2026):** Item 1 — approved direction (Option C), NOT built, awaiting Kevin's fresh explicit go-ahead to execute the build plan. Item 2 — needs scoping (see the Option D brief); no design or build until Kevin answers its open questions.
